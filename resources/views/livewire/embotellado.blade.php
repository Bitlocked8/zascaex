<div class="p-2 mt-20 flex justify-center bg-white">
  <div class="w-full max-w-screen-xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="flex items-center gap-2 mb-4 col-span-full">
      <input type="text" wire:model.live="search" placeholder="Buscar por código o observación..."
    ...
    @forelse($embotellados as $embotellado)
      <div class="bg-white shadow rounded-lg p-4 grid grid-cols-12 gap-4 items-center">
        ...
        <div class="flex flex-col col-span-9 text-left space-y-1">
          ...
          <p><strong>Producto generado:</strong>
            {{ $embotellado->existenciaProducto->existenciable->descripcion ?? 'N/A' }}
            ({{ $embotellado->cantidad_generada ?? 0 }})</p>
        ...
        <div class="flex flex-col items-end gap-4 col-span-3">
          ...
          <button wire:click="modaldetalle({{ $embotellado->id }})" class="btn-circle btn-cyan" title="Ver Detalle">
          ...
          <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-wrap justify-center gap-2 mb-2">
              @foreach(\App\Models\Sucursal::all() as $sucursal)
                <button type="button" @if($accion === 'edit') disabled @else
                wire:click="filtrarPorSucursal({{ $sucursal->id }})" @endif
            ...
            <div class="grid grid-cols-2 gap-2">
              ...
              <div>
                ...
                <div
                  class="w-full border border-gray-300 rounded-md shadow-sm p-2 bg-white grid grid-cols-1 gap-2 overflow-y-auto max-h-[170px]">
                  @foreach($bases as $base)
                    <button type="button" @if($accion === 'edit') disabled @else
                    wire:click="$set('existencia_base_id', {{ $base->id }})" @endif
              ...
              <div>
                ...
                <div
                  ...
                  @foreach($tapas as $tapa)
                    <button type="button" @if($accion === 'edit') disabled @else
                    wire:click="$set('existencia_tapa_id', {{ $tapa->id }})" @endif
                      class="w-full px-3 py-2 rounded-md border text-sm text-left transition
            ...
            <div class="grid grid-cols-2 gap-2 mt-2">
              <div>
                ...
                <input type="number" class="input-minimal" @if($accion === 'edit') value="{{ $cantidad_base_usada }}"
                disabled @else wire:model="cantidad_base_usada" @endif>
              ...
              <div>
                ...
                <input type="number" class="input-minimal" @if($accion === 'edit') value="{{ $cantidad_tapa_usada }}"
                disabled @else wire:model="cantidad_tapa_usada" @endif>
            ...
            <div class="grid grid-cols-2 gap-2 mt-2">
              ...
              <div class="flex flex-wrap justify-center gap-2 mb-2">
                @foreach(\App\Models\Sucursal::all() as $sucursal)
                  <button type="button" wire:click="cambiarSucursalProductos({{ $sucursal->id }})"
            ...
            <div class="grid grid-cols-2 gap-2 mt-2">
              ...
              <div>
                ...
                <div class="flex flex-wrap gap-2">
                  @foreach([0 => 'Espera Lote', 1 => 'Asignado'] as $key => $label)
                    <button type="button" wire:click="$set('estado_residuo_base', {{ $key }})"
              ...
              <div>
                ...
                <div class="flex flex-wrap gap-2">
                  @foreach([0 => 'Espera Lote', 1 => 'Asignado'] as $key => $label)
                    <button type="button" wire:click="$set('estado_residuo_tapa', {{ $key }})"
            ...
            <div class="flex flex-wrap justify-center gap-2 mt-2">
              @foreach(['pendiente' => 'Pendiente', 'terminado' => 'Terminado'] as $st => $label)
                <button type="button" wire:click="$set('estado','{{ $st }}')" class="px-4 py-2 rounded-full text-sm flex items-center justify-center

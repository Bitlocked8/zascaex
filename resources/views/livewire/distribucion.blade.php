            ...
            <div class="card-teal flex flex-col gap-4">
              ...
              {{ $dist->estado == 1 ? 'bg-yellow-600 text-white' : 'bg-emerald-400 text-white' }}">
                ...
                <div
                    ...
                    <button wire:click="verPedidos({{ $dist->id }})" class="btn-cyan flex items-center gap-1 flex-shrink-0"
                        title="Ver pedidos">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    @foreach($personals as $p)
                                        <button type="button" wire:click="$set('personal_id', {{ $p->id }})" class="w-full p-4 rounded-lg border-2 transition flex flex-col items-center text-center
                        ...
                        <div class="grid grid-cols-1 gap-2 mt-2">
                            <div>
                                ...
                                <div
                                    ...
                                    @foreach($coches as $c)
                                        <button type="button" wire:click="$set('coche_id', {{ $c->id }})" class="w-full p-4 rounded-lg border-2 transition flex flex-col items-center text-center
                            ...
                            <div
                                ...
                                @forelse($pedidosDisponibles as $pedido)
                                    <div
                                        ...
                                        <span
                                            class="font-semibold text-u">{{ $pedido->cliente->nombre ?? 'Cliente N/A' }}</span>

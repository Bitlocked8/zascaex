  ...
  <div class="w-full max-w-screen-xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white shadow rounded-lg p-4 grid grid-cols-12 gap-4 items-center">
      <div class="flex flex-col col-span-9 text-left space-y-1">
        <p><strong>Nombre:</strong> {{ $tapa->descripcion ?? 'N/A' }}</p>
        <p><strong>Observaciones:</strong> {{ $tapa->observaciones ?? 'N/A' }}</p>
      ...
      <div class="flex flex-col items-end gap-4 col-span-3">
        <button wire:click="abrirModal('edit', {{ $tapa->id }})" class="btn-circle btn-cyan">
        ...
        <button wire:click="modaldetalle({{ $tapa->id }})" class="btn-circle btn-cyan"
          title="Ver Detalle">
      ...
      <div class="modal-content">
        <div class="flex flex-col gap-4">
          ...
          <div>
            ...
            <input type="text" wire:model="tipo" class="input-minimal" placeholder="Tipo de tapa">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="flex flex-col gap-3">
            <div class="flex flex-col sm:flex-row sm:items-center gap-2">
              ...
              <span class="badge-info">{{ $tapaSeleccionada->estado ? 'Activo' : 'Inactivo' }}</span>
            </div>
          </div>
          <div class="flex flex-col gap-3">
            ...
            <div class="flex flex-col sm:flex-row sm:items-start gap-2">
              ...
              <span class="badge-info">{{ $tapaSeleccionada->observaciones ?? '-' }}</span>
            </div>
          </div>
        </div>
      </div>

<div>
    ...
    <nav id="menu" class="w-[95%] max-w-[1700px] text-cyan-600 bg-cyan-600 px-6 py-2 mt-4 shadow-lg fixed left-1/2 -translate-x-1/2 top-[65px] hidden transition-all rounded-xl backdrop-blur-md z-20 ">
                    ...
                    <div class="flex flex-wrap justify-center gap-4">
                       ...
                       ? 'bg-teal-600 text-white' : 'bg-cyan-600 text-white hover:bg-teal-600' }}">
                        ...
                        <button
                            ...
                            class="w-24 h-24 flex flex-col items-center justify-center rounded-xl
                             {{ ($seleccion == 'Venta') ? 'bg-teal-600 text-white' : 'bg-cyan-600 text-white hover:bg-teal-600' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mb-1">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <button
                            ...
                            class="w-24 h-24 flex flex-col items-center justify-center rounded-xl
                             {{ ($seleccion == 'Asignacion') ? 'bg-teal-600 text-white' : 'bg-cyan-600 text-white hover:bg-teal-600' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mb-1">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />

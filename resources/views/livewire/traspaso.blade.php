                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <div class="w-full border border-gray-300 rounded-md shadow-sm p-2 bg-white grid grid-cols-1 gap-2 overflow-y-auto max-h-[150px]">
                            ...
                            @endphp
                            <button type="button"
                                wire:click="$set('origen_id', {{ $item->reposicionesIds[0] }})"
                    ...
                    <div>
                        ...
                        <div class="w-full border border-gray-300 rounded-md shadow-sm p-2 bg-white grid grid-cols-1 gap-2 overflow-y-auto max-h-[150px]">
                            ...
                            @endphp
                            <button type="button"
                                wire:click="$set('destino_id', {{ $item->reposicionesIds[0] }})"
                                class="w-full px-3 py-2 rounded-md border text-sm text-left flex justify-between items-center transition
                    ...
                    <div>
                        ...
                        <textarea wire:model="observaciones" placeholder="Observaciones" class="input-minimal w-full"></textarea>
                    </div>
                </div>
            </div>

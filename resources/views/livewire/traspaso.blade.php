            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-teal-50 sticky top-0 z-10">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-teal-700 font-semibold">Sucursal Origen</th>
                        <th class="px-4 py-2 text-left text-teal-700 font-semibold">Sucursal Destino</th>
                        <th class="px-4 py-2 text-left text-teal-700 font-semibold">Cantidad</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-teal-50">
                        <td class="px-4 py-2">{{ $traspaso->codigo ?? 'N/A' }}</td>
                        <td class="px-4 py-2">{{ $traspaso->fecha_traspaso ?? 'N/A' }}</td>
                        <td class="px-4 py-2">{{ $traspaso->personal?->nombres ?? 'N/A' }}</td>
                        <td class="px-4 py-2">
                        ...
                        <td class="px-4 py-2">{{ $traspaso->cantidad ?? 'N/A' }}</td>

                ...
                <div class="card-teal flex flex-col gap-4">
                    <div class="flex flex-col gap-1">
                        <p class="text-emerald-600 uppercase font-semibold">
                            {{ class_basename($soplado->asignado->existencia->existenciable ?? '') }}:
                            {{ $soplado->asignado->existencia->existenciable->descripcion ?? 'N/A' }}
                        </p>
    ...
    <div class="modal-overlay">
        <div class="modal-box">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click="$set('confirmingDeleteSopladoId', null)" class="btn-cyan" title="Cerrar">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path d="M5 5l3.585 3.585a4.83 4.83 0 0 0 6.83 0l3.585 -3.585" />
